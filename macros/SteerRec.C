...
void SteerRec(std::string inFilename="simul",std::string outFilename="recResult",double deltaPhi,double zBinWidth,double deltaZ,double deltaNentries,double zWidth){
  ...
  double ResStep=(kResMax-kResMin)/((double)kNresBins);
